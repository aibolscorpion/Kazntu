...
public class PushNotificationFragment extends Fragment {
    ...
    public static PushNotificationFragment newInstance() {
        ...
        public void onActivityCreated(Bundle savedInstanceState){
            ...
            pushNotificationViewModel = ViewModelProviders.of(this).get(PushNotificationViewModel.class);
            ...
            pushNotificationViewModel.getPushNotificationList();
    ...
    private void setUpItemTouchHelper() {
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            public int getSwipeDirs(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
                ...
                PushNotificationAdapter testAdapter = (PushNotificationAdapter) recyclerView.getAdapter();
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                PushNotificationAdapter adapter = (PushNotificationAdapter) fragmentPushNotificationBinding.pushNotificationRecyclerView.getAdapter();
